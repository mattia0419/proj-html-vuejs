    ...
    <footer>
        <div class="row row-cols-md-2 row-cols-lg-4 g-4">
            <div class="col p-5">
                ...
                <p>While the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of
            ...
            <div class="col">
                ...
                <ul>
                    <li v-for="link in links1">{{ link }}</li>
                </ul>
            </div>
            <div class="col">
                <h3>{{ title2 }}</h3>
                ...
                <ul>
                    <li v-for="link in links2">{{ link }}</li>
                </ul>
            </div>
            <div class="col">
                <h3>{{ title3 }}</h3>
                ...
                <img :src="buildingImagePath(link3)" alt="">
            </div>
        </div>
